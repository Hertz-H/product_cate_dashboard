    ...
    <div class="container ">
        ...
        <div class="dashboard d-flex  " style="gap:70px">
            ...
            <div class="form-container  ">
                ...
                <h3 > add product</h3>
                <form class="row g-3  "action='controls.php' method='post' enctype='multipart/form-data'>
                  
                    <div class="col-md-6">
                      <label for="Proficiency" class="form-label">zipFile</label>
                      <input type="file" class="form-control" id="Proficiency" name="file_z"required >
                    </div>
